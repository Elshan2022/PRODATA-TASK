...
class _$PlaceModelImpl implements _PlaceModel {
  ...
  @override
  String toString() {
    return 'PlaceModel(id: $id, name: $name, address: $address, latitude: $latitude, longitude: $longitude, category: $category)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, address, latitude, longitude, category);
...
abstract class _PlaceModel implements PlaceModel {
  const factory _PlaceModel(
      ...
      required final String category}) = _$PlaceModelImpl;
